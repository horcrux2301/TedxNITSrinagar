				...
				>
					<div className='row speaker'>
						...
						<div className='col-sm-7 col-xs-12'>
							<div className= {this.state.visible ? 'speaker-image speaker-image-animate' : 'speaker-image is-hidden' } style={{ 'backgroundImage': `url(${this.props.imgLg})` }}>
							</div>
						</div>
					</div>
				</VisibilitySensor>
				...
				>
					<div className='row speaker'>
						<div className='col-sm-5 col-xs-12'>
							<div className= {this.state.visible ? 'speaker-image speaker-image-animate speaker-float-right' : 'speaker-image speaker-float-right is-hidden' } style={{ 'backgroundImage': `url(${this.props.imgLg})` }}>
							</div>
						</div>
